      ...
      <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
        <Link to="/">
          ...
          >
            ...
            <span className={`text-xl font-bold tracking-tight ${scrolled ? 'text-slate-900 dark:text-white' : 'text-zinc-300'}`}>
                ...
                <motion.span
                  ...
                  className={`font-medium transition-colors flex items-center gap-2 cursor-pointer ${
                    location.pathname === link.href
                      ? "text-emerald-500"
                      : scrolled
                        ? "text-slate-600 dark:text-slate-500 hover:text-emerald-500"
