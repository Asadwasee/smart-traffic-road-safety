...
export default function RoadSafetyTips() {
  return (
    <section
      id="safety"
      className="relative overflow-hidden bg-[#0f172a] py-24 px-6"
    >
      {/* Dot-grid background */}
      <div
      ...
      {/* Radial glow */}
      <div className="pointer-events-none absolute inset-x-0 top-0 h-80 bg-[radial-gradient(ellipse_at_top,_rgba(16,185,129,0.12),_transparent_65%)]" />
      ...
      <div className="relative mx-auto max-w-7xl">
          ...
          {safetyTipsData.map((tip) => {
            ...
            return (
              <motion.div
                ...
                className={`group relative cursor-default rounded-2xl border ${tip.border} ${tip.bg} p-6 backdrop-blur transition-shadow duration-300 hover:shadow-[0_16px_40px_rgba(0,0,0,0.5)]`}
              >
                {/* Icon */}
                <div
        ...
        <motion.div
          ...
          transition={{ duration: 0.6 }}
          className="mt-20 rounded-3xl border border-rose-500/25 bg-rose-500/10 p-8 text-center"
        >
          <PhoneCall className="mx-auto mb-4 text-rose-400" size={36} />
          ...
          <div className="mt-6 flex flex-wrap justify-center gap-4">
            {[
              ...
              <div
                key={item.label}
                className="rounded-xl border border-rose-500/30 bg-rose-500/15 px-6 py-3"
              >
                <p className="text-xs text-rose-300">{item.label}</p>
