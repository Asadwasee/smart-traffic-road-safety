...
export default function RouteSuggestion() {
  ...
  return (
    <section
      id="routes"
      className="relative bg-slate-950 min-h-screen pt-28 pb-24 overflow-hidden"
    >
      {/* Top glow */}
      <div
        className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[240px] pointer-events-none"
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6">
        ...
        >
          ...
          <p className="text-slate-400 text-sm md:text-base max-w-md mx-auto leading-relaxed">
            Get the fastest, safest path with animated map visualization and
            real-time traffic analysis for Lahore.
          </p>
        </motion.div>
        ...
        <AnimatePresence mode="wait">
          {isLoading && (
            ...
            >
              ...
              <div className="text-center">
                ...
                <p className="text-slate-500 text-xs mt-1">Analysing traffic conditions</p>
              </div>
            </motion.div>
          )}
          ...
          {!isLoading && !showResult && (
            ...
            >
              ...
              <p className="text-slate-600 text-sm">Choose a start and destination to get your route</p>
            </motion.div>
          )}
        </AnimatePresence>
      </div>
